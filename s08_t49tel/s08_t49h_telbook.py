...
# В файле должны находиться след.данные: Фамилия, Имя, Отчество, номер телефона 
# (+ описание контакта). Требуемый функционал:
# 1. Программа должна по запросу выводить данные (на экран) 
# 2. Программа должна сохранять данные в (текстовом) файле
# 3. Пользователь должен иметь возможность ввести одну из харатеристик для поиска определенной записи
# (например, имя или фамилию человека)
# 4. Программа не должна быть линейной, должна использовать функции.
# 5+. Иметь функционал изменения, дополнения и удаления данных.
